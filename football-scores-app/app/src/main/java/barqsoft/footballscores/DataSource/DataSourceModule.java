...
public class DataSourceModule {
    ...
    RestAdapter provideRestAdapter(Endpoint endpoint, @Named("Api") OkHttpClient client, Gson gson) {
        return new RestAdapter.Builder()
                ...
                .setRequestInterceptor(request -> request.addHeader("X-Authorization", ConstantValues.API_KEY))
                .build();
    }

    @Provides
    FootballAPI provideShareLinkApi(RestAdapter restAdapter) {
        return restAdapter.create(FootballAPI.class);
    }
}
